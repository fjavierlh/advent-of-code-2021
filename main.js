import {
  getNumberMeasurementsIncrease,
  getNumberMeasurementsIncreaseByThree,
} from "./day-01-sonar-sweep/index.js";
import { inputDataDay01 } from "./day-01-sonar-sweep/input.data.js";
import {
  getHorizontalPositionMultiplyByDepth,
  getHorizontalPositionMultiplyByDepthAim,
} from "./day-02-dive/index.js";
...
const resultDay01Part2 = getNumberMeasurementsIncreaseByThree(inputDataDay01);
...
const resultDay02Part2 =
  getHorizontalPositionMultiplyByDepthAim(inputDataDay02);
