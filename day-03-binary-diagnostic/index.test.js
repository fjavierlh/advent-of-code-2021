import { getSubmarineLifeSupportRating, getSubmarinePowerConsumption } from ".";
...
describe("getSubmarineLifeSupportRating", () => {
  ...
  test("should return the life support rating of the submarine ", () => {
    const expectedResult = 230;
    const result = getSubmarineLifeSupportRating(mockInput);
    expect(result).toBe(expectedResult);
  });
});
